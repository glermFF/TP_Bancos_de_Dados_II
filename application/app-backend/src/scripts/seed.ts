...
const CITIES: CitySeed[] = [
  ...
  { name: 'Lagoa Dourada', region: 'Vertentes', lat: -20.9128, lon: -44.0776 },
...
const DISTILLERIES: DistillerySeed[] = [
  ...
  { name: 'Cachaça Sabinosa', city: 'Salinas', category: 'Envelhecida', rating: 4.6, founded: null, signature: 'Sabinosa Jequitibá', tags: ['prata na ExpoCachaça', 'produção familiar'], lat: -16.1490, lon: -42.2745 },
  { name: 'Cachaça Salineira', city: 'Salinas', category: 'Envelhecida', rating: 4.5, founded: null, signature: 'Salineira Bálsamo', tags: ['tradição salinense', 'bálsamo da região'], lat: -16.1915, lon: -42.2988 },
  { name: 'Cachaça Piragibana', city: 'Salinas', category: 'Branca', rating: 4.4, founded: null, signature: 'Piragibana Prata', tags: ['cana da região', 'rótulo tradicional'], lat: -16.1583, lon: -42.3129 },
  { name: 'Cachaça Lua Cheia', city: 'Salinas', category: 'Envelhecida', rating: 4.4, founded: null, signature: 'Lua Cheia Bálsamo', tags: ['capital da cachaça', 'garrafa lapidada'], lat: -16.1731, lon: -42.2678 },
  ...
  { name: 'Engenho Boa Vista — Século XVIII', city: 'Coronel Xavier Chaves', category: 'Histórica', rating: 4.8, founded: null, signature: 'Cachaça Século XVIII', tags: ['alambique mais antigo em atividade', 'métodos coloniais'], lat: -21.0180, lon: -44.2330 },
  { name: 'Alambique Velho Ferreira', city: 'Prados', category: 'Envelhecida', rating: 4.5, founded: null, signature: 'Velho Ferreira Madeiras Nobres', tags: ['vila do Bichinho', 'envelhecimento em várias madeiras'], lat: -21.0520, lon: -44.0950 },
  { name: 'Cachaça Bocaina', city: 'Lagoa Dourada', category: 'Envelhecida', rating: 4.6, founded: 1993, signature: 'Bocaina Carvalho', tags: ['terra do rocambole', 'agroindústria familiar'], lat: -20.9128, lon: -44.0776 },
  { name: 'Engenho Buriti', city: 'Ouro Preto', category: 'Envelhecida', rating: 4.5, founded: null, signature: 'Buriti Envelhecida', tags: ['mais de cem anos', 'técnicas de família'], lat: -20.4020, lon: -43.5410 },
